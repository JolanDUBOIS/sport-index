...
#         unique_tournament_id: str | None = None,
#         season_id: str | None = None,
#         target: Literal["constructors", "drivers"] | None = None,
#         season_stage_id: str | None = None,
#         **kwargs
#     ) -> list[TeamStandings] | RacingStandings | None
#         Fetch standings for a tournament or a racing stage.
...
#     @staticmethod
#     def get_ranking_ids() -> dict[str, str]:
#         """
#         Returns a mapping of available ranking IDs to their slug.
...
#     def get_categories(self, sport_slug: str) -> list[Category]:
#         """
#         Fetch all categories for a given sport.
...
#         """
#         try:
#             categories_raw = self.provider.get_categories(sport=sport_slug)
...
#             return UniqueTournament.from_api(unique_tournament_raw.get("uniqueTournament", {}))
#         except (RateLimitError, FetchError):
...
#     def get_events(self, sport_slug: str, date: str) -> list[Event]:
#         """
...
#         """
#         try:
#             events_raw = self.provider.get_scheduled_events(sport=sport_slug, date=date)
...
#     def get_standings(self, unique_tournament_id: str | None = None, season_id: str | None = None, season_stage_id: str | None = None, **kwargs) -> list[TeamStandings] | list[RacingStandings] | None:
#         """
#         Fetch standings for a tournament or a racing stage.
...
#         season_id : str, optional
#             The ID of the season.
#         season_stage_id : str, optional
#             The ID of the season stage (for racing).
#         **kwargs
#             Additional keyword arguments for the provider.

#         Returns
#         -------
#         list[TeamStandings] or list[RacingStandings] or None
#             Standings object(s) depending on the input parameters.
#         """
#         try:
#             if unique_tournament_id or season_id:
#                 if not unique_tournament_id or not season_id:
#                     raise ValueError("Both unique_tournament_id and season_id are required for fetching unique tournament standings.")
...
#             elif season_stage_id:
#                 standings_raw = []
#                 standings_raw.append({"standings": self.provider.get_stage_standings_competitors(stage_id=season_stage_id), "kind": "constructors"})
#                 standings_raw.append({"standings": self.provider.get_stage_standings_teams(stage_id=season_stage_id), "kind": "drivers"})
#                 # It's not a mistake, the "competitors" endpoint returns constructors standings and the "teams" endpoint returns drivers standings
#                 return [RacingStandings.from_api(std_raw) for std_raw in standings_raw]
#             else:
#                 raise ValueError("Insufficient parameters: provide either (unique_tournament_id and season_id) or (target and season_stage_id).")
#         except (RateLimitError, FetchError):
