...
#     "team-results": f"{ENDPOINT_BASE}/team/{{team_id}}/results.json?team-id={{team_id}}&entity-page=results", # + competition filter optional
#     "team-players": f"{ENDPOINT_BASE}/team/{{team_id}}/squad.json?team-id={{team_id}}&entity-page=squad", # + competition filter optional
