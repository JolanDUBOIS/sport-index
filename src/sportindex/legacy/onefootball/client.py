...
# See docs/football/DATA_CONTRACT.md for output structures and guarantees. TODO
# """
...
# class OneFootballClient(SportClient):
#     """
...
#                         match["competition"]["name"] = raw_match.get("competitionName") or get_nested(raw_match, "competition.name")
...
#                 "img_path": get_nested(match, "competition.icon.path") or get_nested(match, "competitionLogo.path"),
#             },
#             "contextual": {
#                 "stage_label": None,
#             },
